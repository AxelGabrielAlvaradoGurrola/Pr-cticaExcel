...
public class G4S21JDCGexel {
    ...
    public static void main(String[] args) {
        ...
        try ( OutputStream fileOut = new FileOutputStream("archivo.xls")) {
            ...
            Sheet sheet = wb.createSheet("Tercer Hoja datos");
            ...
            row.createCell(3).setCellValue("fernando@gmail.com"); // Columna D 
            ...
            row.createCell(3).setCellValue("alma1523@gmail.com"); // Columna D
            ...
            row.createCell(3).setCellValue("javier12032@gmail.com"); // Columna D
